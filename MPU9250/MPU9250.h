...
public:
    ...
    bool update() {
		...
		realPitch = quat_filter.returnPitch();
		realYaw = quat_filter.returnYaw();
		realRoll = quat_filter.returnRoll();
	...
	float getRealRoll() { return realRoll; }
    float getRealPitch() { return realPitch; }
    float getRealYaw() { return realYaw; }
