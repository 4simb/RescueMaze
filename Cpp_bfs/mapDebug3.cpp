...
void filling() {
/*    (25; 25): (25; 26),(25; 24),(24; 25)
(24; 25): (25; 25),(23; 25)
(23; 25): (24; 25),(23; 24),(22; 25)
(22; 25): (23; 25),(21; 25)
(21; 25): (22; 25),(21; 24)
(21; 24): (21; 25)
*/
    ...
    smezh[smezh.size() - 1].push_back(make_pair(25, 26));
    smezh[smezh.size() - 1].push_back(make_pair(25, 24));
    ...
    smezh[smezh.size() - 1].push_back(make_pair(22, 25));

    smezh.push_back(vector<pair<int, int> >());
    smezh[smezh.size() - 1].push_back(make_pair(22, 25));
    smezh[smezh.size() - 1].push_back(make_pair(23, 25));
    smezh[smezh.size() - 1].push_back(make_pair(21, 25));

    smezh.push_back(vector<pair<int, int> >());
    smezh[smezh.size() - 1].push_back(make_pair(21, 25));
    smezh[smezh.size() - 1].push_back(make_pair(22, 25));
    smezh[smezh.size() - 1].push_back(make_pair(21, 24));
