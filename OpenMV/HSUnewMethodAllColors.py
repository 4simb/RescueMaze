...
threshold_green = (28, 0, -128, -11, -128, 127)#(0, 100, -128, -7, -128, 127)
...
while(True):
    ...
    yList = []
    message = " "
    for yb in img.find_blobs([threshold_black], area_threshold = 300):#area_threshold = 2000):
        if yb.pixels() > 20:
    ...
    for elements in copies:
        ...
        for yb in img.find_blobs([threshold_black], area_threshold = 0):
