...
threshold_black = (15, 0, -128, 127, -128, 127)#(26, 0, -128, 127, -128, 127)#(28, 0, -128, 127, 127, -128)
threshold_yellow = (100, 0, -128, 45, 32, 127)
threshold_green = (0, 100, -128, -11, -128, 127)#(28, 0, -128, -11, -128, 127)#(0, 100, -128, -7, -128, 127)
...
while(True):
    ...
    if not(state):
        for yb in img.find_blobs([threshold_black], pixel_threshold = 2000, area_threshold = 1000, merge = True, margin = 100):#area_threshold = 2000):
            if yb.w()/yb.h() > 0.4 and yb.w()/yb.h() < 2.5:
