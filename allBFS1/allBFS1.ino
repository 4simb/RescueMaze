...
int thresholdMVLeft = 13, thresholdMVRight = 13; //30 30
int kL = 0, kR = 0;
int stateOld = -1;
...
int raveHistLength = 20, countBack = 0, countForw = 0;
bool backRave = false, forwRave = false;
Queue<int> queBack;
Queue<int> queForw;

Vector<Vector<pair> > smezh;
short int robotDirection = 0; //УВАГА
...
//Colors
Vec3b black = Vec3b(30, 96, 87);
Vec3b blue = Vec3b(-23, 60, 89);
Vec3b white = Vec3b(127, 165, 172);
Vec3b silver = Vec3b(150, 150, 150);
