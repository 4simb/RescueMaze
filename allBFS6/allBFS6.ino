...
#define thresholdMVLeft 15
#define thresholdMVRight 15
#define pitchThresoldDown 11
#define pitchThresoldUp -10
...
byte offerSize = 4;
byte offerI;
int offerBackward[] = {65, 370, 665, 950};
