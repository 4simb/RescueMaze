...
class CameraParams {
  public:
    ...
    bool camera;
    CameraParams(int first, int second, int floor, int dir, bool cam) {
      this->first = first;
      this->second = second;
      this->floor = floor;
      this->dir = dir;
    ...
    bool isEqual(int first, int second, int floor, int dir, bool cam) {
      return this->first == first && this->second == second
             && this->floor == floor && this->dir == dir && this->camera == cam;
    }
};
